function [baseline] = DetectBaseline(single_traces,AcquisitionFrequency,PacingFrequency)
...
for i = 1:length(single_traces)
    for l = 1:length(single_traces(i).data)

            cll = {single_traces(i).data.beats_cut}.';
